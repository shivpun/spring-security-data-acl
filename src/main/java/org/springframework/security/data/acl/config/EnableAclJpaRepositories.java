...
@Documented
@Inherited
@Import(value = { AclJpaRepositoriesRegistrar.class })
public @interface EnableAclJpaRepositories {
	...
	/**
	 * Configures the name of the {@link EntityManagerFactory} bean definition to be
	...
	/**
	 * Configures the name of the {@link PlatformTransactionManager} bean definition
	 * to be used to create repositories discovered through this annotation.
	 * Defaults to {@code transactionManager}.
	 *
	 * @return
	 */
	...
	/**
	 * Configures whether to enable default transactions for Spring Data JPA
	 * repositories. Defaults to {@literal true}. If disabled, repositories must be
	 * used behind a facade that's configuring transactions (e.g. using Spring's
	 * annotation driven transaction facilities) or repository methods have to be
	 * used to demarcate transactions.
	 *
