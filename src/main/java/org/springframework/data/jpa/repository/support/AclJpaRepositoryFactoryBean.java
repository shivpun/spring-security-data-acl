...
public class AclJpaRepositoryFactoryBean<T extends Repository<S, ID>, S, ID> extends JpaRepositoryFactoryBean<T, S, ID> {
	...
	public AclJpaRepositoryFactoryBean(Class<? extends T> repositoryInterface, AclJpaSpecification<Object> aclJpaSpecification) {
		super(repositoryInterface);
		this.aclJpaSpecification = aclJpaSpecification;
	}

	protected RepositoryFactorySupport createRepositoryFactory(EntityManager entityManager) {
		AclJpaRepositoryFactory jpaRepositoryFactory = new AclJpaRepositoryFactory(entityManager, aclJpaSpecification);
